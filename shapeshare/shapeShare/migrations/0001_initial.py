    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shapeShare.Attribute')),
            ],
        ),
        migrations.CreateModel(
            name='Feature',
        ...
        migrations.AddField(
            model_name='feature',
            name='shapefile',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shapeShare.Shapefile'),
        ),
        migrations.AddField(
            model_name='attributevalue',
            name='feature',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shapeShare.Feature'),
        ),
        migrations.AddField(
